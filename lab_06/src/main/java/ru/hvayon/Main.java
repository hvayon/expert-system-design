...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Node node9 = new Node("C", 0, Arrays.asList(W));
        ...
        Edge m1 = new Edge("m1", node9, new ArrayList<>(Arrays.asList(node6, node7)));
        ...
        List<Edge> edgeList = new ArrayList<>(Arrays.asList(m1, m2, m3));
